    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
             ...
             <div class="container">
			  <h2><c:if test="${subjectMaster != null}">
                        Edit Subject
                    </c:if>
                    <c:if test="${subjectMaster == null}">
                        Add New Subject
                    </c:if></h2>
	           <c:if test="${subjectMaster != null}">
			  ...
			  <input type="hidden" name="sid" id="sid" value="<c:out value='${subjectMaster.id}' />"/>
			   <input type="hidden" name="ccode" id="ccode" value="<c:out value='${subjectMaster.ccode}' />"/>
			  <div class="form-group" style="padding:15px;">
			    ...
			    <div class="form-group"  style="padding:15px;">
			      ...
			      <input type="text" class="form-control" id="scode" name="scode" value="<c:out value='${subjectMaster.scode}' />" placeholder="Enter Subject Code"  required>
			    </div>
			    <div class="form-group" style="padding:15px;">
			      <label for="cname">Subject Name:</label>
			      <input type="text" class="form-control" id="sname" name="sname" value="<c:out value='${subjectMaster.sName}' />" placeholder="Enter Subject Name"  required>
			    </div>
			    <c:if test="${subjectMaster != null}">

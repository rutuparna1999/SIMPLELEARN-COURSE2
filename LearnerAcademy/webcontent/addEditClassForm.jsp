    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
             ...
             <div class="container">
			  <h2><c:if test="${classMaster != null}">
                        Edit Class
                    </c:if>
                    <c:if test="${classMaster == null}">
                        Add New Class
                    </c:if></h2>
			<c:if test="${classMaster != null}">
	        ...
	        <c:if test="${classMaster == null}">
			  ...
			  <input type="hidden" name="classid" id="classid" value="<c:out value='${classMaster.id}' />"/>
			    <div class="form-group"  style="padding:15px;">
			      <label for="ccode">Class Code:</label>
			      <input type="text" class="form-control" id="ccode" name="ccode" value="<c:out value='${classMaster.ccode}' />" placeholder="Enter Class Code"  required>
			    </div>
			    <div class="form-group" style="padding:15px;">
			      <label for="cname">Class Name:</label>
			      <input type="text" class="form-control" id="cname" name="cname" value="<c:out value='${classMaster.cName}' />" placeholder="Enter Class Name"  required>
			    </div>
			    <c:if test="${classMaster == null}">

	        ...
	        <c:if test="${userMaster == null}">
	          ...
	          <input type="hidden" name="hiduname" id="hiduname" value="<c:out value='${userMaster.uname}' />"/>
			    ...
			    <div class="form-group" style="padding:15px;">
			      ...
			      <input type="text" class="form-control" id="fname" name="fname" value="<c:out value='${userMaster.fName}' />" placeholder="Enter First Name"  required>
			    </div>
			    
			     <div class="form-group" style="padding:15px;">
			      <label for="fname">Last Name:</label>
			      <input type="text" class="form-control" id="lname" name="lname" value="<c:out value='${userMaster.lName}' />" placeholder="Enter Last Name"  required>
			     </div>
			   <c:if test="${userMaster != null}">

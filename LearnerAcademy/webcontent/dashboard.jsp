...
<body>
    <nav class="navbar navbar-light bg-light p-3">
        ...
        <div class="col-12 col-md-5 col-lg-8 d-flex align-items-center justify-content-md-end mt-3 mt-md-0">
            ...
            <div class="dropdown">
                <a href="logout"><button class="btn btn-secondary" type="button" id="dropdownMenuButton">
                 Sign Out
                </button></a>
              </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="card" >
				  <img src="http://cdn4.iconfinder.com/data/icons/circle-avatars-1/128/042_girl_avatar_profile_woman_shirt-2-512.png"  style="width:100%">
				  <h1>${user.fName}</h1>
				  <p class="title">${user.school}</p>
				  <p>${user.role}</p>

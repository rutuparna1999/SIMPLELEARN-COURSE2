             ...
             <div class="container">
			  ...
			  <div class="form-group" style="padding:15px;">
			      ...
			      <option value = ""> Select Subject  </option>  
			       <c:forEach var="subjectMaster" items="${listSubject}">   
	                    <option value="<c:out value="${subjectMaster.scode}" />"><c:out value="${subjectMaster.sName}" /></option>
			      </c:forEach>   
				</select> 
			    </div>
			    <div class="form-group" style="padding:15px;">
			      ...
			      <option value = ""> Select Teacher  </option>  
			       <c:forEach var="userMaster" items="${listTeacher}">   
	                    <option value="<c:out value="${userMaster.uname}" />"><c:out value="${userMaster.fName}" /><c:out value="${userMaster.lName}" /></option>
			      </c:forEach>   
				</select> 
			    </div>
